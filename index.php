        ...
        <nav class="navbar" style="background:#2c3e50">
		  <div class="container-fluid">
			<div class="navbar-header">
			  <a class="navbar-brand" href="#"> <i class="glyphicon glyphicon-qrcode"></i>  QR Code Asistencia</a>
			</div>
		<ul class="nav navbar-nav">
			  ...
			  <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#"><span class="glyphicon glyphicon-cog"></span> Maintenance <span class="caret"></span></a>
				<ul class="dropdown-menu">
				  ...
				  <li><a href="newUser.php"><span class="glyphicon glyphicon-plus-sign"></span> Nuevo Usuario</a></li>
       ...
       <div class="container">
            <div class="row">
                <div class="col-md-4" style="padding:10px;background:#fff;border-radius: 5px;" id="divvideo">
					<center><p class="login-box-msg"> <i class="glyphicon glyphicon-camera"></i>PULSE AQUÍ</p></center>
					...
					if(isset($_SESSION['error'])){
					  echo "
						...
						<audio src='sonidoerror.mp3' autoplay ></audio>	
					  ";
					...
					if(isset($_SESSION['success'])){
					  echo "
						<div class='alert alert-success alert-dismissible' style='background:green;color:#fff'>
						  ...
						  ".$_SESSION['success']."
						  <audio src='sonido.mp3' autoplay ></audio>	
						</div>
                ...
                <form action="CheckInOut.php" method="post" class="form-horizontal" style="border-radius: 5px;padding:10px;background:#fff;" id="divvideo">
                     <i class="glyphicon glyphicon-qrcode"></i> <label>ESCANEAR CÓDIGO QR</label> <p id="time"></p>
                    <input type="text" name="studentID" id="text" placeholder="Escanear código QR / N° DNI" class="form-control"   autofocus>
                </form>
